 ...
 * 
 * SupplierにセットするProductにはバリューホルダーを使用します.
 */
...
public class SupplierMapper {
	...
	public static class ProductLoader implements ValueHolder.ValueLoader<Product> {
		private long id;
	...
	public Supplier find(long id) {
		try {
			...
			supplier.setProducts(new ValueHolder<Product>(new ProductLoader(id)));
			return supplier;
