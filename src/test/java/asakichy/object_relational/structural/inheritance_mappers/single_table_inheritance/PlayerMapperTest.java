...
import asakichy.object_relational.structural.inheritance_mappers.single_table_inheritance.Player.TYPE;
...
public class PlayerMapperTest {
	...
	public void 準備() throws SQLException {
		...
		stmt.execute("CREATE TABLE players ( id BIGINT PRIMARY KEY, name VARCHAR(32), "
				+ "type VARCHAR(32), club VARCHAR(32), batting_average BIGINT, bowling_average BIGINT)");

		stmt.execute("INSERT INTO players VALUES(0,'山田太郎','FOOTBALL','インテル',NULL,NULL)");
		stmt.execute("INSERT INTO players VALUES(1,'山田花子','CRICKET',NULL,500,NULL)");
		stmt.execute("INSERT INTO players VALUES(2,'山田次郎','BOWLING',NULL,300,200)");
	}
