...
public class SupplierMapperTest {
	...
	@Test
	public void 仮想プロキシー() throws Exception {
		Supplier supplier = SupplierMapper.instance.find(0);
		...
		VirtualList<Product> vl1 = (VirtualList<Product>) products;
		VirtualList<Product> vl2 = (VirtualList<Product>) products_second;
		assertThat(vl1.getSource(), sameInstance(vl2.getSource()));
	}
